...
import { MessageRent } from "../values";
import 'react-slideshow-image/dist/styles.css';

const RentDetails = ( { data, ID } ) => {
            ...
            <div className="details" key={data.id}>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <span></span>
                        <td>
                            {`${data.total_apartment_meter_square}m²`}
                        </td>
                        <span></span>
                        <td>
                            {data.year_biult}
                ...
                <Form >
                    <Segment>
                        ...
                        <Form.Field>
                            ...
                            <Form.TextArea label="MESSAGE " type="text"  placeholder={`${MessageRent}at ${data.house_number} ${data.street_name}...`} required/>
